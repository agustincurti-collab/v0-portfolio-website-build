...
export function CTA() {
  return (
    <section className="relative py-24 px-4 sm:px-6 lg:px-8 overflow-hidden bg-gradient-to-b from-background via-background to-secondary/30">

      {/* Gradient Glow */}
      <div className="absolute inset-0 -z-10 flex justify-center">
        <div className="w-[600px] h-[600px] bg-accent/20 blur-[120px] rounded-full opacity-40"></div>
      </div>
