    ...
    <section className="relative overflow-hidden pt-32 pb-20 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-7xl mx-auto text-center">
        ...
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-accent/30 bg-accent/10 mb-8 backdrop-blur transition-all duration-300 hover:scale-105">
          ...
          <span className="text-sm text-accent">{t.hero.badge}</span>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <Button asChild className="rounded-full bg-secondary hover:bg-secondary/80 text-foreground px-6 py-3 h-auto transition-all duration-300 hover:scale-[1.04] shadow-xl">
            <a href="#work">
              {t.hero.ctaWork}
